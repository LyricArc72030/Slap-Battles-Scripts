...
AutoChann:Label("WARNING ⚠️: SOMETIMES THE AUTO SLAPPLE FARM DOESN'T WORK AND SOMETIMES SOME DEVICES CRASHED!") 
...
BadgesChann:Label("TIP ℹ️: Recommended to TP to SafeSpot if your farming for Voodoo, Fish, Trap/Moyai and Bob!")
...
BadgesChann:Label("Note 📝: In Order to use Get [ R E D A C T E D ]!, you must have 5k slaps or above!") 
