...
local TrollSection = PlayerTab:NewSection("Troll")
...
AutoSection:NewToggle("Auto Slapple Farm", "Auto Farms Slapple for you!", function(bool)
...
BadgesSection:NewToggle("Bob Farm", "Auto Farms Bob for you till you spawned Bob!", function(bool)
        bobFarm = bool        
        if bool == true then           
            while bobFarm do               
                task.wait()              
...
PerksSection:NewSlider("Set Walkspeed", "Set your speed when you walk!", 400, 20, function(WS)
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = WS
        WS1 = WS
end)

PerksSection:NewToggle("Auto Set Walkspeed", "Auto set your Setted Walkspeed when you respawn!", function(bool)
        autoSet1 = bool
        if bool == true then
            while autoSet1 do
                task.wait()
...
PerksSection:NewSlider("Set Jumppower", "Set your jumppower when you jump!", 400, 50, function(JP)
        game.Players.LocalPlayer.Character.Humanoid.JumpPower = JP     
        WS2 = JP
end)

PerksSection:NewToggle("Auto Set Jumppower", "Auto Set your Setted Jumppower! ", function(bool)
        autoSet2 = bool
        if bool == true then
            while autoSet2 do
                task.wait()
...
for i, v in pairs(HWIDTable) do
      if v == HWID then
           print("Enjoy!")
local TeleportsSection = PlayerTab:NewSection("Teleports (Owner Only)")

TeleportsSection:NewButton("TP to SafeSpot", "Tp you to SafeSpot (Good for Farming!)", function()
    if not workspace:FindFirstChild("Spot") then
    local SafeSpot = Instance.new("Part", workspace)
    SafeSpot.Position = Vector3.new(-5516,104,-3433) 
    SafeSpot.Name = "Spot"    
    ...
    if workspace[game.Players.LocalPlayer.Name]:FindFirstChild("entered") then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.Spot.CFrame * CFrame.new(0,8,0)
            ...
            print("Enter the Arena First to farm Tycoon! ")
        end
end)

TeleportsSection:NewButton("TP to Arena", "TP you to Arena!", function()
...
TeleportsSection:NewButton("TP to Tournament", "Click the button if the Tournament starts!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
...
TeleportsSection:NewButton("TP to Tournament Lobby", "Where all players waiting before starts!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
