...
OrionLib:MakeNotification({
	Name = "Game Detected! Loading Script...",
	Content = "If the script doesn't fully load, try re-executing it!",
...
Set:AddTextbox({
	Name = "Set Walkspeed (Enter Input Number!)",
	Default = "20",
	TextDisappear = true,
...
Set:AddTextbox({
	Name = "Set Jumppower (Enter Input Number!)",
	Default = "50",
	TextDisappear = true,
