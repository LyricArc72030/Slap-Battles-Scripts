...
Badges:AddButton({
	...
	Time = 6
          ...
          OrionLib:MakeNotification({
	Name = "TP to SafeSpot Failed!",
	Content = "You Must Enter the Arena First!",
	Image = "rbxassetid://4483345998",
	Time = 6
})           
...
Annoy:AddToggle({
	Name = "Spam Space Sound (Must Equip Space!)",
	Default = false,
	Callback = function(bool)
                                                        if bool == true then
          OrionLib:MakeNotification({
...
Annoy:AddToggle({
	Name = "Spam Ping Pong (Must Equip Ping Pong!)",
	Default = false,
	Callback = function(bool)
                                                            if bool == true then
          OrionLib:MakeNotification({
...
Annoy:AddToggle({
	Name = "Spam Thanos Sound (Must Equip Thanos!)",
	Default = false,
	Callback = function(bool)
                                                              if bool == true then
          OrionLib:MakeNotification({
...
OrionLib:MakeNotification({
	Name = "Script Fully Loaded Successfully!",
