...
----------------------------------------------------------------------------------
local TeleportsTab = Window:NewTab("Teleports (Beta)")
local ModesSection = TeleportsTab:NewSection("Modes")
...
AreaSection:NewButton("TP to Tournament", "Click the button if the Tournament will starts!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
...
AreaSection:NewButton("TP to Moyai Island", "TP you to Moyai Island!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart 
...
AreaSection:NewButton("TP to Slapple Island", "TP you to Slapple Island (Keypad) Spot!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart 
...
AreaSection:NewButton("TP to Golden Slapple", "TP you where Golden Slapple spawns!", function()
local pl = game.Players.LocalPlayer.Character.HumanoidRootPart  
...
ModesSection:NewButton("TP to Killstreak Only", "TP you to Killstreak Only Gamemode!", function()
        game:GetService("TeleportService"):Teleport(11520107397)
end)

ModesSection:NewButton("TP to No Oneshot", "TP you to No Oneshot Gamemode!", function()
        game:GetService("TeleportService"):Teleport(9015014224)
end)

ModesSection:NewButton("TP to Slap Royale", "TP you to Slap Royale!", function()
...
ModesSection:NewButton("TP to Normal Gamemode", "TP you to Normal Gamemode!", function()
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Script Loaded!";
    Text = "Thank you for using our Script! Enjoy!!";
    Duration = 10;
})
